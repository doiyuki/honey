...
(function() {
  this.SplashesController = (function() {
    function SplashesController() {}

    SplashesController.prototype.index = function() {
      var jumpToStreams;
      jumpToStreams = function() {
        return window.location.href = gon.streams_index_url;
      };
      return setTimeout(jumpToStreams, 3000);
    };

    return SplashesController;

  })();

}).call(this);
(function() {
  this.StreamsController = (function() {
    function StreamsController() {}

    StreamsController.prototype.index = function() {
...
//  ... other scripts here ... (because of jquery.turbolinks)
